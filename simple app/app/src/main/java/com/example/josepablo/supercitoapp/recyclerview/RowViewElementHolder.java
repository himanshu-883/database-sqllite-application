...
public class RowViewElementHolder extends RecyclerViewElementAdapter.CustomViewHolder implements View.OnClickListener{

    // TODO: 8.- Creamos una nueva clase que extienda a un ViewHolder e implentamos un ClickListeenr

    private RecycleViewClickListener listener;

    public RowViewElementHolder(View itemView, RecycleViewClickListener listener){
        super(itemView);
